"""Initial legal schema with users, projects, and threads

Revision ID: 0001_initial_legal_schema
Revises: 
...
revision: str = "0001_initial_legal_schema"
...
def upgrade() -> None:
    ...
    op.create_index("idx_threads_project_id", "threads", ["project_id"], unique=False)
